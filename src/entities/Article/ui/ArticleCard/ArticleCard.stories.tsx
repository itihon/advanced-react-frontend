...
export const LightArticleCardTileLoadingImage: Story = {
  args: withEmptyImage(args),
  decorators: [ThemeDecorator],
};

export const DarkArticleCardTileLoadingImage = {
  args: withEmptyImage(args),
  decorators: [ThemeDecorator],
  parameters: { theme: Themes.DARK },
};
...
export const LightArticleCardListItemLoadingImage: Story = {
  args: {
    ...withEmptyImage(args),
    previewStyle: ArticlePreviewStyle.LIST_ITEMS,
  },
...
export const DarkArticleCardListItemLoadingImage = {
  args: {
    ...withEmptyImage(args),
    previewStyle: ArticlePreviewStyle.LIST_ITEMS,
  },
...
export const LightArticleCardRowLoadingImage: Story = {
  args: {
    ...withEmptyImage(args),
    previewStyle: ArticlePreviewStyle.ROW,
  },
...
export const DarkArticleCardRowLoadingImage = {
  args: {
    ...withEmptyImage(args),
    previewStyle: ArticlePreviewStyle.ROW,
  },
