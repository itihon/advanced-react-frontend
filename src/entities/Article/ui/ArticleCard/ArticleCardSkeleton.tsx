...
const ArticleCardSkeleton: React.FC<ArticleCardSkeletonProps> = ({ previewStyle, className }) => {
  const isList = previewStyle === ArticlePreviewStyle.LIST_ITEMS;

  return (
    <div className={classNames(classes.ArticleCard, classes[previewStyle], ownClasses.ArticleCardSkeleton, className)} style={{ height: 'unset' }}>
